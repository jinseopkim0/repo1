...
```Groovy
compile 'com.google.api:gax:2.54.2',
  'com.google.api:gax-grpc:2.54.2'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.api" % "gax" % "2.54.2"
libraryDependencies += "com.google.api" % "gax-grpc" % "2.54.2"
```
